let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `KATAKURI_MD SUPPORT CHANNEL\n\n _*YO HERE'S OUR CHANNEL, SUPPORT TO KEEP THIS PROJECT ALIVE*_\n *LINK:* \n\n ${Config.botname} *©Phantom*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*KATAKURI_MD CURRENTLY ACTIVE!*";
