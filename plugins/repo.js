...
smd({
  ...
  try {
    const response = await axios.get("https://api.github.com/repos/Phantom-kin/KATAKURI_MD");
    ...
    replyMessage += `**✨Repository URL:** [Click here]👉(https://github.com/Phantom-kin/KATAKURI_MD)\n`;
